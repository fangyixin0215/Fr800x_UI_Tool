...
//		this.sortPal = ['hue-','lum-','sat-'];
		...
		this.colorDist = opts.colorDist == "manhatten" ? distManhattan : opts.colorDist == "euclidean" ? distEuclidean : distEuclidean;
...
//			buf8 = data.buf8,
	...
	RgbQuant.prototype.reducePal = function reducePal(idxi32) {
		...
		// reduce histogram to create initial palette
			...
			var len = idxrgb.length,
				palLen = len,
				iter = 0,
				thold = this.reduceDist(iter, null, palLen, palLen, palLen);
			...
			if (palLen > this.colors) {
				while (palLen > this.colors) {
					...
					thold = this.reduceDist(++iter, thold, palLen, 'lastSize', len);
				}
	...
	// gets called at beginning of each palette reduction pass to get updated 'eat-if' distance
	RgbQuant.prototype.reduceDist = function reduceDist(iter, curDist, curSize, lastSize, origSize) {
//		console.log("palette reduction pass: " + iter + "; length: " + curSize);
		if (iter == 0)
			return this.initDist;
		else {
			// if palette is still much larger than target, increment by larger initDist
			return curDist + ((curSize > this.colors * 3) ? this.initDist : this.distIncr);
		}
	};
	...
	var rd = 255,
		gd = 255,
		bd = 255,
		euclMax = Math.sqrt(Pr*rd*rd + Pg*gd*gd + Pb*bd*bd);
